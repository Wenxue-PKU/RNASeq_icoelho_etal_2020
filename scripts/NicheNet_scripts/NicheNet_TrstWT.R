################# 1st - Define Expressed Genes for Sender Cells ################
 
#Filter the dm object to get only the WT's Samples of Transition Cells
Trst_wt<-dm[,dm$Grouping_Genotype=="Transition_WT"]

#Save the counts into a dataframe
df<-counts(Trst_wt,normalized = FALSE)

#Run the TPM transformation
source("scripts/NicheNet_scripts/NicheNet_TPM_transf.R")

#Define the criteria for filtering the expressed genes
crit<- df_tpm %>% apply(1,function(x){log2(mean(x) + 1)}) %>% .[. >=4] %>% names()

#filter the sender df to get the gene symbols of the expressed genes for sender cells
...
################# 2nd - Define Expressed Genes for Receiver Cells - LDECs ################

#Get the dm object only for LDAM samples
LDAM<-dm[,dm$Grouping=="LDAM"]

#Save the counts into a new df object
df<-counts(LDAM,normalized = FALSE)

#Run the TPM transformation
source("scripts/NicheNet_scripts/NicheNet_TPM_transf.R")

#Applying the filtering criteria for the receiver cells
crit<- df_tpm %>% apply(1,function(x){log2(mean(x) + 1)}) %>% .[. >=4] %>% names()

#Filtering the receiver dataset to include only the genes that pass through the filtering criteria & transform them into gene symbols
...
######### 3rd - Perform the NicheNet Analysis for LDECs ################### 

#Create the sub-folders to store the results
...
#Import the genes of interest
genes<-read.xlsx("Gene_NicheNet_070120.xlsx",sheetIndex = 1,header=T)

#Import the genes of interest that are also present in the ligand target matrix for NicheNet
...
#save the dataframe into an excell file
...
#save the histogram plot into a .tiff file
tiff("NicheNet/Transition_WT/LDECs/Plots/PCC_TrsntWT_LDECS_Hist.tiff", width = 1500, height = 1000,res = 150)
p_hist_lig_activity
dev.off()

##### A. Analysis for the Best 20 Ligands ######
#Save the best 20 ligands into a new object
best_upstream_ligands = ligand_activities %>% top_n(20, pearson) %>% arrange(-pearson) %>% pull(test_ligand)

#Save the heatmap corresponding to the PCC values of the best ligands
source("scripts/NicheNet_scripts/NicheNet_PCC_Heatmap.R")
tiff("NicheNet/Transition_WT/LDECs/Plots/PCC_TrsntWT_LDECS_Best20.tiff", width = 600, height = 1000,res = 150)
p_ligand_pearson
dev.off()

source("scripts/NicheNet_scripts/NicheNet_Ligands_to_Genes.R")

tiff("NicheNet/Transition_WT/LDECs/Plots/GenesHeatmap_TrsntWT_LDECS_Hist_Best20_DB500.tiff", width = 2000, height = 1000,res = 150)
...
tiff("NicheNet/Transition_WT/LDECs/Plots/GenesHeatmap_TrsntWT_LDECS_Hist_Best20_DB250.tiff", width = 2000, height = 1000,res = 150)
...
tiff("NicheNet/Transition_WT/LDECs/Plots/GenesHeatmap_TrsntWT_LDECS_Hist_Best20_DB100.tiff", width = 2000, height = 1000,res = 150)
...
source("scripts/NicheNet_scripts/NicheNet_PCC_Heatmap.R")
tiff("NicheNet/Transition_WT/LDECs/Plots/PCC_TrsntWT_LDECS_Best10.tiff", width = 600, height = 1000,res = 150)
p_ligand_pearson
dev.off()

tiff("NicheNet/Transition_WT/LDECs/Plots/GenesHeatmap_TrsntWT_LDECS_Hist_Best10_DB500.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_500
...
tiff("NicheNet/Transition_WT/LDECs/Plots/GenesHeatmap_TrsntWT_LDECS_Hist_Best10_DB250.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_250
dev.off()
...
tiff("NicheNet/Transition_WT/LDECs/Plots/GenesHeatmap_TrsntWT_LDECS_Hist_Best10_DB100.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_100
...
df<-counts(Endo,normalized = FALSE)
...
source("scripts/NicheNet_scripts/NicheNet_PCC_Heatmap.R")
tiff("NicheNet/Transition_WT/Endo/Plots/PCC_TrsntWT_Endo_Best20.tiff", width = 600, height = 1000,res = 150)
p_ligand_pearson
dev.off()

source("scripts/NicheNet_scripts/NicheNet_Ligands_to_Genes.R")

tiff("NicheNet/Transition_WT/Endo/Plots/GenesHeatmap_TrsntWT_Endo_Hist_Best20_DB500.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_500
...
tiff("NicheNet/Transition_WT/Endo/Plots/GenesHeatmap_TrsntWT_Endo_Hist_Best20_DB250.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_250
dev.off()
...
tiff("NicheNet/Transition_WT/Endo/Plots/GenesHeatmap_TrsntWT_Endo_Hist_Best20_DB100.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_100
...
source("scripts/NicheNet_scripts/NicheNet_PCC_Heatmap.R")
tiff("NicheNet/Transition_WT/Endo//Plots/PCC_TrsntWT_Endo_Best10.tiff", width = 600, height = 1000,res = 150)
p_ligand_pearson
dev.off()

source("scripts/NicheNet_scripts/NicheNet_Ligands_to_Genes.R")

tiff("NicheNet/Transition_WT/Endo/Plots/GenesHeatmap_TrsntWT_Endo_Hist_Best10_DB500.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_500
...
tiff("NicheNet/Transition_WT/Endo/Plots/GenesHeatmap_TrsntWT_Endo_Hist_Best10_DB250.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_250
dev.off()
...
tiff("NicheNet/Transition_WT/Endo/Plots/GenesHeatmap_TrsntWT_Endo_Hist_Best10_DB100.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_100
...
df<-counts(Com,normalized = FALSE)
...
source("scripts/NicheNet_scripts/NicheNet_PCC_Heatmap.R")
tiff("NicheNet/Transition_WT/Common//Plots/PCC_TrsntWT_Common_Best20.tiff", width = 600, height = 1000,res = 150)
p_ligand_pearson
dev.off()

source("scripts/NicheNet_scripts/NicheNet_Ligands_to_Genes.R")

tiff("NicheNet/Transition_WT/Common/Plots/GenesHeatmap_TrsntWT_Common_Hist_Best20_DB500.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_500
...
tiff("NicheNet/Transition_WT/Common/Plots/GenesHeatmap_TrsntWT_Common_Hist_Best20_DB250.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_250
dev.off()
...
tiff("NicheNet/Transition_WT/Common/Plots/GenesHeatmap_TrsntWT_Common_Hist_Best20_DB100.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_100
...
source("scripts/NicheNet_scripts/NicheNet_PCC_Heatmap.R")
tiff("NicheNet/Transition_WT/Common/Plots/PCC_TrsntWT_Common_Best10.tiff", width = 600, height = 1000,res = 150)
p_ligand_pearson
dev.off()

source("scripts/NicheNet_scripts/NicheNet_Ligands_to_Genes.R")

tiff("NicheNet/Transition_WT/Common/Plots/GenesHeatmap_TrsntWT_Common_Hist_Best10_DB500.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_500
...
tiff("NicheNet/Transition_WT/Common/Plots/GenesHeatmap_TrsntWT_Common_Hist_Best10_DB250.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_250
dev.off()
...
tiff("NicheNet/Transition_WT/Common/Plots/GenesHeatmap_TrsntWT_Common_Hist_Best10_DB100.tiff", width = 2000, height = 1000,res = 150)
p_ligand_target_network_100
