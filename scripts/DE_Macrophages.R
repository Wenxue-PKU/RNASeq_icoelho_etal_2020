...
#######################
dir.create(path = "DE_Macrophages/", showWarnings = FALSE)
dir.create(path = "DE_Macrophages/Diff_Exp/", showWarnings = FALSE)
dir.create(path = "DE_Macrophages/Diff_Exp/DE_Results", showWarnings = FALSE)
dir.create(path = "DE_Macrophages/Diff_Exp/VD", showWarnings = FALSE)

dir.create(path = "DE_Macrophages/Up_Regulated/", showWarnings = FALSE)
dir.create(path = "DE_Macrophages/Up_Regulated/DE_Results", showWarnings = FALSE)
dir.create(path = "DE_Macrophages/Up_Regulated/VD", showWarnings = FALSE)

dir.create(path = "DE_Macrophages/Down_Regulated/", showWarnings = FALSE)
dir.create(path = "DE_Macrophages/Down_Regulated/DE_Results", showWarnings = FALSE)
dir.create(path = "DE_Macrophages/Down_Regulated/VD", showWarnings = FALSE)
...
#write.xlsx(de1_filt,file = "DE_Macrophages/Diff_Exp/DE_Results/WT_DE_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[2],"_vs_",comp[1],"_filt"),append = F)
#write.xlsx(de2_filt,file = "DE_Macrophages/Diff_Exp/DE_Results/WT_DE_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[3],"_vs_",comp[1],"_filt"),append = T)
#write.xlsx(de3_filt,file = "DE_Macrophages/Diff_Exp/DE_Results/WT_DE_Macrophages_Results.xlsx",
...
#write.xlsx(up1_filt,file = "DE_Macrophages/Up_Regulated/DE_Results/WT_Up_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[2],"_vs_",comp[1],"_up_filt"),append = F)
#write.xlsx(up2_filt,file = "DE_Macrophages/Up_Regulated/DE_Results/WT_Up_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[3],"_vs_",comp[1],"_up_filt"),append = T)
#write.xlsx(up3_filt,file = "DE_Macrophages/Up_Regulated/DE_Results/WT_Up_Macrophages_Results.xlsx",
...
#write.xlsx(down1_filt,file = "DE_Macrophages/Down_Regulated/DE_Results/WT_Down_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[2],"_vs_",comp[1],"_down_filt"),append = F)
#write.xlsx(down2_filt,file = "DE_Macrophages/Down_Regulated/DE_Results/WT_Down_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[3],"_vs_",comp[1],"_down_filt"),append = T)
#write.xlsx(down3_filt,file = "DE_Macrophages/Down_Regulated/DE_Results/WT_Down_Macrophages_Results.xlsx",
...
#write.xlsx(de1_filt,file = "DE_Macrophages/Diff_Exp/DE_Results/KO_DE_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[2],"_vs_",comp[1],"_filt"),append = F)
#write.xlsx(de2_filt,file = "DE_Macrophages/Diff_Exp/DE_Results/KO_DE_Macrophages_Results.xlsx",
          # sheetName = paste0(comp[3],"_vs_",comp[1],"_filt"),append = T)
#write.xlsx(de3_filt,file = "DE_Macrophages/Diff_Exp/DE_Results/KO_DE_Macrophages_Results.xlsx",
          # sheetName = paste0(comp[3],"_vs_",comp[2],"_filt"),append = T)
...
#write.xlsx(up1_filt,file = "DE_Macrophages/Up_Regulated/DE_Results/KO_Up_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[2],"_vs_",comp[1],"_up_filt"),append = F)
#write.xlsx(up2_filt,file = "DE_Macrophages/Up_Regulated/DE_Results/KO_Up_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[3],"_vs_",comp[1],"_up_filt"),append = T)
#write.xlsx(up3_filt,file = "DE_Macrophages/Up_Regulated/DE_Results/KO_Up_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[3],"_vs_",comp[2],"_up_filt"),append = T)
...
#write.xlsx(down1_filt,file = "DE_Macrophages/Down_Regulated/DE_Results/KO_Down_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[2],"_vs_",comp[1],"_down_filt"),append = F)
#write.xlsx(down2_filt,file = "DE_Macrophages/Down_Regulated/DE_Results/KO_Down_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[3],"_vs_",comp[1],"_down_filt"),append = T)
#write.xlsx(down3_filt,file = "DE_Macrophages/Down_Regulated/DE_Results/KO_Down_Macrophages_Results.xlsx",
           #sheetName = paste0(comp[3],"_vs_",comp[2],"_down_filt"),append = T)
...
for (i in 1:length(wt_de_list)) {
  ...
  write.xlsx(join_df,file = paste0("DE_Macrophages/Diff_Exp/VD/",names(wt_de_list)[i],
                                   "_Genes_VD.xlsx"),sheetName = "Genes_Overlap",append = F)
  write.xlsx(wt_df,file = paste0("DE_Macrophages/Diff_Exp/VD/",names(wt_de_list)[i],
                                 "_Genes_VD.xlsx"),sheetName = "Genes_WT_Only",append = T)
  write.xlsx(ko_df,file = paste0("DE_Macrophages/Diff_Exp/VD/",names(wt_de_list)[i],
                                   "_Genes_VD.xlsx"),sheetName = "Genes_KO_Only",append = T)
  
  
  tiff(paste0("DE_Macrophages/Diff_Exp/VD/", names(wt_de_list)[i],"_DE.tiff",sep=""), width = 1500, height = 1000,res = 150)
...
for (i in 1:length(wt_up_list)) {
  ...
  write.xlsx(join_df,file = paste0("DE_Macrophages/Up_Regulated/VD/",names(wt_de_list)[i],
                                   "_Genes_VD.xlsx"),sheetName = "Genes_Overlap",append = F)
  write.xlsx(wt_df,file = paste0("DE_Macrophages/Up_Regulated/VD/",names(wt_de_list)[i],
                                   "_Genes_VD.xlsx"),sheetName = "Genes_WT_Only",append = T)
  write.xlsx(ko_df,file = paste0("DE_Macrophages/Up_Regulated/VD/",names(wt_de_list)[i],
                                  "_Genes_VD.xlsx"),sheetName = "Genes_KO_Only",append = T)
  
  
  tiff(paste0("DE_Macrophages/Up_Regulated/VD/", names(wt_de_list)[i],"_Up.tiff",sep=""), width = 1500, height = 1000,res = 150)
...
for (i in 1:length(wt_down_list)) {
  ...
  write.xlsx(join_df,file = paste0("DE_Macrophages/Down_Regulated/VD/",names(wt_de_list)[i],
                                   "_Genes_VD.xlsx"),sheetName = "Genes_Overlap",append = F)
  write.xlsx(wt_df,file = paste0("DE_Macrophages/Down_Regulated/VD/",names(wt_de_list)[i],
                                   "_Genes_VD.xlsx"),sheetName = "Genes_WT_Only",append = T)
  write.xlsx(ko_df,file = paste0("DE_Macrophages/Down_Regulated/VD/",names(wt_de_list)[i],
                                 "_Genes_VD.xlsx"),sheetName = "Genes_KO_Only",append = T)
  
  
  tiff(paste0("DE_Macrophages/Down_Regulated/VD/", names(wt_de_list)[i],"_Down.tiff",sep=""), width = 1500, height = 1000,res = 150)
